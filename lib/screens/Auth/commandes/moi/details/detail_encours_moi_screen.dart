...
//detail en cours
class DetailEncoursMoiScreen extends StatefulWidget {
  const DetailEncoursMoiScreen({super.key, required this.order});
  final Order order;

  @override
  State<DetailEncoursMoiScreen> createState() => _DetailEncoursMoiScreenState();
}

class _DetailEncoursMoiScreenState extends State<DetailEncoursMoiScreen> {
  late Order _order;
  int bon = 0;
              ...
              Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Text(
                      _order.delivery.time.substring(0, 5),
                      style: const TextStyle(
                        fontSize: 16,
                      ),
                    ),
