...
import 'package:distribution_frontend/screens/Auth/commandes/moi/update/formulaire_update_commande_moi_screen.dart';
...
//detail en cours
class DetailNouvelleMoiScreen extends StatefulWidget {
  const DetailNouvelleMoiScreen({super.key, required this.order});
  final Order order;

  @override
  State<DetailNouvelleMoiScreen> createState() =>
      _DetailNouvelleMoiScreenState();
}

class _DetailNouvelleMoiScreenState extends State<DetailNouvelleMoiScreen> {
  late Order _order;
  int bon = 0;
            ...
            children: [
              ...
              Container(
                padding: EdgeInsets.only(
                  top: 20,
                  bottom: _order.detail != null ? 20 : 60,
                ),
                alignment: Alignment.center,
                child: const Text(
                  'Votre commande est en cours d\'analyse ',
                  style: TextStyle(
                    color: colorBlue,
                  ),
                ),
                ...
                TextButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            FormulaireUpdateCommandeMoiScreen(order: _order),
                      ),
                    );
                  },
                  child: const Text(
