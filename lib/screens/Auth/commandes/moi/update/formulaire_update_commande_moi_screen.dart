...
class FormulaireUpdateCommandeMoiScreen extends StatefulWidget {
  const FormulaireUpdateCommandeMoiScreen({
    super.key,
    required this.order,
  });
  final Order order;
  ...
  @override
  State<FormulaireUpdateCommandeMoiScreen> createState() =>
      _FormulaireUpdateCommandeMoiScreenState();
}

class _FormulaireUpdateCommandeMoiScreenState
    extends State<FormulaireUpdateCommandeMoiScreen> {
  ...
  Future<void> updateCommande() async {
    ApiResponse response = await updateCommandeMoi(
        widget.order.id,
        _nbcmd.toString(),
                ...
                onTap: () => Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => ClickProduit(
                      product: widget.order.items[0].product,
                    ),
                  ),
                ),
                child: Container(
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceBetween,
                                children: [
                                  Text('Livraison ${_order.items[0].fees}'),
                                  Text(
