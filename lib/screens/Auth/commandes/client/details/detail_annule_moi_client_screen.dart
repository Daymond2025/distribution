...
//detail annulemoi
class DetailAnnuleMoiClientScreen extends StatefulWidget {
  const DetailAnnuleMoiClientScreen({super.key, required this.commande});
  final dynamic commande;
  @override
  State<DetailAnnuleMoiClientScreen> createState() =>
      _DetailAnnuleMoiClientScreenState();
}

class _DetailAnnuleMoiClientScreenState
    extends State<DetailAnnuleMoiClientScreen> {
  late Order _order;
