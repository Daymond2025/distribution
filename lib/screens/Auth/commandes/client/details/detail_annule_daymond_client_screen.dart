...
//detail annuledaymond
class DetailAnnuleDaymondClientScreen extends StatefulWidget {
  const DetailAnnuleDaymondClientScreen({super.key, required this.commande});
  final dynamic commande;

  @override
  State<DetailAnnuleDaymondClientScreen> createState() =>
      _DetailAnnuleDaymondClientScreenState();
}

class _DetailAnnuleDaymondClientScreenState
    extends State<DetailAnnuleDaymondClientScreen> {
  late Order _order;
