...
class FormulaireRenvoieCommandeAnnuleScreen extends StatefulWidget {
  const FormulaireRenvoieCommandeAnnuleScreen({
    super.key,
    required this.order,
  });
  final Order order;
  ...
  @override
  State<FormulaireRenvoieCommandeAnnuleScreen> createState() =>
      _FormulaireRenvoieCommandeAnnuleScreenState();
}

class _FormulaireRenvoieCommandeAnnuleScreenState
    extends State<FormulaireRenvoieCommandeAnnuleScreen> {
  ...
  Future<void> updateCommande() async {
    ApiResponse response = await renovieCommandeClient(
        widget.order.id,
        _nbcmd.toString(),
        _nomController.text,
    ...
    return Scaffold(
                  ...
                  child: Column(
                    children: [
                                        ...
                                        InkWell(
                                          onTap: () {
                                            setState(() {
                                              if (_nbcmd != 1) {
                                                _nbcmd = _nbcmd - 1;
                                                onChange(_order.items[0].product
                                                            .type ==
                                                        'grossiste'
                                                    ? _prixController.text
                      ...
                      _order.items[0].product.type == 'grossiste'
                          ...
                          : Container(),
                      _order.items[0].product.type == 'commission'
                          ? Container(
                              alignment: Alignment.topLeft,
                              padding:
                                  const EdgeInsets.only(left: 5, bottom: 5),
                          ...
                          : Container(),
                      _order.items[0].product.type == 'louer'
                          ? Container(
                              alignment: Alignment.topLeft,
                              padding:
                                  const EdgeInsets.only(left: 5, bottom: 5),
      ...
      bottomSheet: Container(
        ...
        child: _loading
            ...
            : kTextButtonCmd('RENVOYER LA COMMANDE', () {
