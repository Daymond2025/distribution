...
import 'package:distribution_frontend/widgets/floating_audio_button.dart';
...
class _AccueilScreenState extends State<AccueilScreen> {
  ...
  /// Gère l'état de lecture du bouton audio flottant
  /// TODO: Intégrer le player audio réel
  void _toggleAudio() {
    setState(() {
    ...
    if (_isAudioPlaying) {
      print('Démarrage de la lecture audio');
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
                        ...
                        children: [
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: <Widget>[
                                  // Carrousel des bannières/couvertures
                                            ...
                                            Padding(
                                              ...
                                              child: GridView.builder(
                                                ...
                                                itemBuilder: (_, index) {
                                                  if (!_loading) {
                                                    if (index == 0) {
                                                      // Première carte : ClicCard pour les produits à 25 clics
                                                      return ClicCard(
                                                        onTap: () {
                                                          Navigator.push(
                                                            context,
                                                      ...
                                                      // Cartes suivantes : affichage des produits
        ...
        // TODO: Remplacer les données mockées par des données depuis l'API
        if (!_loading)
          FloatingAudioButton(
